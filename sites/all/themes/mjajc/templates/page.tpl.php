...
<div id="page">
  ...
  <?php if ($is_front): ?>
  <?php if (theme_get_setting('slideshow_display','mjajc')): ?>
  <?php 
    $slide1_head = check_plain(theme_get_setting('slide1_head','mjajc'));   $slide1_desc = check_markup(theme_get_setting('slide1_desc','mjajc'), 'full_html'); $slide1_url = check_plain(theme_get_setting('slide1_url','mjajc'));
    $slide2_head = check_plain(theme_get_setting('slide2_head','mjajc'));   $slide2_desc = check_markup(theme_get_setting('slide2_desc','mjajc'), 'full_html'); $slide2_url = check_plain(theme_get_setting('slide2_url','mjajc'));
    $slide3_head = check_plain(theme_get_setting('slide3_head','mjajc'));   $slide3_desc = check_markup(theme_get_setting('slide3_desc','mjajc'), 'full_html'); $slide3_url = check_plain(theme_get_setting('slide3_url','mjajc'));
  ?>
  <div id="slidebox" class="flexslider">
    <ul class="slides">
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'mjajc') . '/images/slide-image-1.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'mjajc') . '/images/slide-image-2.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'mjajc') . '/images/slide-image-3.jpg'; ?>"/>
    ...
    <div class="container">
      <div class="row">
        <div class="fcred col-sm-12">
          <?php print t('Copyright'); ?>&copy; <a href="<?php print $front_page; ?>"><?php print $site_name; ?></a>. <?php print t('All rights reversed. Been awake and sleepless since 2013.'); ?>
        </div>
      </div>
    </div>
  </div>
